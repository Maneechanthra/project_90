...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2023 at 02:29 PM
...
CREATE TABLE `address` (
  ...
  `Sub_District_id` varchar(10) NOT NULL,
...
CREATE TABLE `applications` (
  ...
  `Income_parents` varchar(10) NOT NULL,
...
INSERT INTO `districts` (`id`, `Postal_Code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
CREATE TABLE `education_information` (
  ...
  `Stady_plan` varchar(20) NOT NULL,
  `Gpax` float NOT NULL,
  `Transcipt` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `facuty` (`Facuty_id`, `Facuty_name`) VALUES
...
INSERT INTO `major` (`Major_id`, `Major_name`, `Facuty_id`, `gpa`) VALUES
('A5201', 'เทคโนโลยีการอาหาร', '03', 2),
('A5301', 'พืชศาสตร์', '03', 2),
('A5401', 'อาหารปลอดภัยและโภชนาการ', '03', 2),
('A5501', 'ทรัพยากรเกษตรและการจัดการการผลิต', '03', 2),
('A5601', 'สัตวศาสตร์ ', '03', 2),
('B5502', 'วิศวกรรมเครื่องกลและการผลิต', '01', 2),
('B5602', 'วิศวกรรมไฟฟ้า', '01', 2.5),
('B5702', 'วิศวกรรมโยธา', '01', 2.75),
('B580', 'เคมีประยุกต์', '01', 2),
('B6001', 'วิทยาการคอมพิวเตอร์', '01', 2),
('B6101', 'วิศวกรรมคอมพิวเตอร์', '01', 2.5),
('B6201', 'วิศวกรรมอุตสาหการ', '01', 2),
('B6401', 'วิศวกรรมโยธาและสิ่งแวดล้อม', '01', 2),
('C5101', 'การจัดการ ', '02', 2),
('C5201', 'การบัญชี', '02', 2),
('C5501', 'การจัดการโรงแรมและท่องเที่ยว', '02', 2),
('C5601', 'ภาษาอังกฤษ', '02', 2),
('C5701', 'การเงิน', '02', 2),
('C5801', 'นิติศาสตร์', '02', 2),
('C5901', 'รัฐประศาสนศาสตร์', '02', 2),
('C6101', 'การจัดการอุตสาหกรรมการบริการ', '02', 2),
('D5101', 'สาธารณสุขศาสตร์', '04', 3.25),
('D5201', 'อนามัยสิ่งแวดล้อม', '04', 2.5),
('D5301', 'อาชีวอนามัยและความปลอดภัย', '04', 3.25);
...
--
-- Table structure for table `register_major`
--

CREATE TABLE `register_major` (
  `App_id` int(11) NOT NULL,
  `Major_id_1` varchar(10) NOT NULL,
  `Major_id_2` varchar(10) NOT NULL,
  `Major_id_3` varchar(10) NOT NULL,
  `Major_id_4` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
ALTER TABLE `applications`
  ADD PRIMARY KEY (`App_id`,`National`,`Tcas_round`);
...
--
ALTER TABLE `major`
  ADD CONSTRAINT `fore_facury` FOREIGN KEY (`Facuty_id`) REFERENCES `facuty` (`Facuty_id`);
COMMIT;
